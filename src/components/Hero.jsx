...
export default function Hero() {
  ...
  useEffect(() => {
    ...
    const resizeCanvas = () => {
      ...
      gctx.strokeStyle = 'rgba(255, 255, 255, 0.015)';
      gctx.lineWidth = 1;
      const gridSize = 60;
    ...
    class ThreatNode {
      ...
      draw(ctx) {
        ...
        // Label text
        ctx.fillStyle = this.intercepted ? '#00FFB2' : 'rgba(255, 255, 255, 0.4)';
  ...
  return (
    <section className="relative w-full min-h-screen flex flex-col justify-between overflow-hidden pt-28">
      ...
      <div className="absolute inset-0 bg-gradient-to-b from-[#050816]/30 via-transparent to-[#050816] pointer-events-none z-1"></div>
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 w-full flex-grow flex flex-col justify-center items-center text-center mt-12">
        <motion.div 
          ...
          className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-white/5 border border-white/10 text-[#00E5FF] text-xs font-semibold tracking-wider mb-8 uppercase"
        >
        ...
        <motion.h1 
          ...
          className="font-display text-4xl sm:text-6xl md:text-7xl font-extrabold tracking-tight text-white max-w-5xl leading-none"
        >
          Stop Fraud <span className="bg-gradient-to-r from-[#00E5FF] via-[#2563EB] to-[#7C3AED] bg-clip-text text-transparent">Before Money Leaves</span> the Account.
        </motion.h1>
        ...
        <motion.p 
          ...
          className="mt-6 text-lg md:text-xl text-[#CBD5E1] max-w-3xl font-light leading-relaxed"
        >
        ...
        >
          <a 
            href="#contact" 
            className="group px-8 py-4 rounded-xl text-base font-semibold text-[#050816] bg-[#00E5FF] flex items-center gap-2 hover:shadow-[0_0_30px_rgba(0,229,255,0.4)] transition-all duration-300"
          >
            Request Demo 
          ...
          <a 
            href="#architecture" 
            className="group px-8 py-4 rounded-xl text-base font-semibold text-white glass-panel flex items-center gap-2 hover:border-white/20 transition-all duration-300"
          >
      ...
      <div className="relative z-10 w-full border-t border-white/5 bg-[#050816]/80 backdrop-blur-sm py-10 mt-auto">
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-2 md:grid-cols-4 gap-8 md:gap-4">
          <div className="flex flex-col items-center md:items-start text-center md:text-left">
            <div className="flex items-center gap-2 text-[#00E5FF] font-semibold text-sm tracking-wider uppercase mb-1">
              <Award className="w-4 h-4" /> RBI Harbinger
            </div>
            <span className="text-white text-xl font-bold">Top 21 Finalist 2025</span>
          </div>

          <div className="flex flex-col items-center md:items-start text-center md:text-left">
            <div className="flex items-center gap-2 text-[#7C3AED] font-semibold text-sm tracking-wider uppercase mb-1">
              <Award className="w-4 h-4" /> Award Winner
            </div>
            <span className="text-white text-xl font-bold">Special Mention Award</span>
          </div>

          <div className="flex flex-col items-center md:items-start text-center md:text-left">
            <div className="flex items-center gap-2 text-white/50 font-semibold text-sm tracking-wider uppercase mb-1">
              <Smartphone className="w-4 h-4 text-white/60" /> Architecture
            </div>
            <span className="text-white text-xl font-bold">5-Layer Protection</span>
          </div>

          <div className="flex flex-col items-center md:items-start text-center md:text-left">
            <div className="flex items-center gap-2 text-[#00FFB2] font-semibold text-sm tracking-wider uppercase mb-1">
              <EyeOff className="w-4 h-4" /> Secure Edge
            </div>
            <span className="text-white text-xl font-bold">100% On-Device Privacy</span>
          </div>
        </div>
