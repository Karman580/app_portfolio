...
export default function HowAIWorks() {
  return (
    <section id="how-it-works" className="relative w-full bg-[#0B1020] py-24 border-b border-white/5">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 mb-16">
          <div className="lg:col-span-6">
            <div className="text-[#00FFB2] font-semibold text-xs tracking-wider uppercase mb-3 flex items-center gap-2">
              <span className="w-1.5 h-1.5 rounded-full bg-[#00FFB2]"></span> Zero-Trust Pipeline
            </div>
            <h2 className="font-display text-3xl sm:text-5xl font-extrabold text-white leading-tight">
              How the AI Works
            </h2>
            <p className="mt-4 text-[#CBD5E1] text-lg font-light leading-relaxed">
          ...
          <div className="lg:col-span-6 flex flex-col justify-center gap-4">
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
              <div className="glass-panel p-5 rounded-2xl text-center border-emerald-500/20">
                <div className="text-[#00FFB2] text-xs font-mono font-bold uppercase mb-1">Local Processing</div>
                <div className="text-[10px] text-[#CBD5E1]">No cloud dependency for threat detection.</div>
              </div>
              <div className="glass-panel p-5 rounded-2xl text-center border-cyan-500/20">
                <div className="text-[#00E5FF] text-xs font-mono font-bold uppercase mb-1">Zero Leaks</div>
                <div className="text-[10px] text-[#CBD5E1]">Zero data exfiltration or recording transfers.</div>
              </div>
              <div className="glass-panel p-5 rounded-2xl text-center border-purple-500/20">
                <div className="text-[#7C3AED] text-xs font-mono font-bold uppercase mb-1">Privacy First</div>
                <div className="text-[10px] text-[#CBD5E1]">Privacy by design compliant with DPDP Act.</div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="relative">
          {/* Connecting Line */}
          <div className="absolute top-[48px] bottom-[48px] left-8 lg:left-1/2 w-0.5 bg-gradient-to-b from-[#00E5FF] via-[#7C3AED] to-[#00FFB2] opacity-20 -translate-x-1/2 hidden lg:block"></div>
              ...
              return (
                ...
                >
                  ...
                  <div className={`w-full lg:w-1/2 flex ${isEven ? 'lg:justify-start' : 'lg:justify-end'}`}>
                    <div className="w-full max-w-md glass-panel p-6 rounded-2xl border-white/5 hover:border-white/10 transition-colors">
                      <div className="flex items-center gap-3 mb-3">
                        <span className="text-xs font-mono font-bold text-white/40">STEP 0{node.step}</span>
                        <div className="h-[1px] flex-grow bg-white/5"></div>
                      </div>
                      <h4 className="text-lg font-bold text-white mb-2">{node.title}</h4>
                      <p className="text-sm text-[#CBD5E1]/80 font-light leading-relaxed">{node.desc}</p>
                    </div>
                  </div>

                  {/* Central Timeline Badge */}
                  <div className="flex items-center justify-center relative z-20 shrink-0 mx-auto lg:mx-0">
                    <div className={`w-14 h-14 rounded-full bg-[#050816] border flex items-center justify-center shadow-2xl ${node.color}`}>
